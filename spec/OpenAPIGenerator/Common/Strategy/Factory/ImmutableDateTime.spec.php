...
describe(OAGC\Strategy\Factory\ImmutableDateTime::class, function ()
{
	afterEach(function ()
	{
		Mockery::close();
	...
	it('creates strategy that extracts date-time without time fraction', function ()
	{
		...
		$factory = new OAGC\Strategy\Factory\ImmutableDateTime();
		$strategy = $factory($container, 'test');
		expect($strategy->extract(new DateTimeImmutable('2020-11-30T23:59:30+04:00')))->toBe('2020-11-30T23:59:30+04:00');
	});
	it('creates strategy that extracts date-time with milliseconds', function ()
	{
		...
		$factory = new OAGC\Strategy\Factory\ImmutableDateTime();
		$strategy = $factory($container, 'test');
		expect($strategy->extract(new DateTimeImmutable('2020-11-30T23:59:30.123+04:00')))->toBe('2020-11-30T23:59:30+04:00');
	});
	it('creates strategy that extracts date-time with microseconds', function ()
	{
		...
		$factory = new OAGC\Strategy\Factory\ImmutableDateTime();
		$strategy = $factory($container, 'test');
		expect($strategy->extract(new DateTimeImmutable('2020-11-30T23:59:30.123456+04:00')))->toBe('2020-11-30T23:59:30+04:00');
	});
	it('creates strategy that hydrates date-time without time fraction', function ()
	{
		...
		expect($date)->toEqual(new DateTimeImmutable('2020-11-30T23:59:30+00:00'));
	});
	it('creates strategy that hydrates date-time with milliseconds', function ()
	{
		...
		expect($date)->toEqual(new DateTimeImmutable('2020-11-30T23:59:30.123+00:00'));
	});
	it('creates strategy that hydrates date-time with microseconds', function ()
	{
		...
		expect($date)->toEqual(new DateTimeImmutable('2020-11-30T23:59:30.123456+00:00'));
	});
});
